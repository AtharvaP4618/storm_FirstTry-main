    ...
    <div className="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
      <div className="row gx-lg-5 align-items-center mb-5">
        <div className="col-lg-6 mb-5 mb-lg-0" style={{ zIndex: 10 }}>
          ...
          >
            Empower, <br />
            <span style={{ color: "hsl(218, 81%, 80%)" }}>
             Engage,  <br />
            </span>
            <span style={{ color: "hsl(218, 75%, 65%)" }}>
              Excel
            </span>
          </h1>
          <p
          ...
          >
            At Employaar, we believe that engaged employees are the heart of a successful organization. Our Employee Feedback and Engagement System is designed to empower your team, foster a culture of open communication, and drive continuous improvement.
          </p>
        </div>
